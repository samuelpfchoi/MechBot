function och = MechWalk_out2()

och.icf = @MechWalk_out2_icf; 
och.tcf = @MechWalk_out2_tcf; 
och.fcf = @MechWalk_out2_fcf; 

och.nlicf = @MechWalk_out2_nlicf; 
och.nltcf = @MechWalk_out2_nltcf; 
och.nlfcf = @MechWalk_out2_nlfcf; 
och.nlgcf = @MechWalk_out2_nlgcf; 



function [f,df] = MechWalk_out2_icf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out2_tcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out2_fcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out2_nlicf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out2_nltcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out2_nlfcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out2_nlgcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
