function och = MechWalk_out3()

och.icf = @MechWalk_out3_icf; 
och.tcf = @MechWalk_out3_tcf; 
och.fcf = @MechWalk_out3_fcf; 

och.nlicf = @MechWalk_out3_nlicf; 
och.nltcf = @MechWalk_out3_nltcf; 
och.nlfcf = @MechWalk_out3_nlfcf; 
och.nlgcf = @MechWalk_out3_nlgcf; 



function [f,df] = MechWalk_out3_icf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out3_tcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out3_fcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out3_nlicf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out3_nltcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out3_nlfcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
...
function [f,df] = MechWalk_out3_nlgcf(a1,a1d,a2,a2d,a3,a3d,a4,a4d,a5,a5d,a6,a6d,a7,a7d)
